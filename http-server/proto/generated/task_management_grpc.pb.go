...
func (c *taskManagementServiceClient) CreateTaskList(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[Task, Task], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &TaskManagementService_ServiceDesc.Streams[0], TaskManagementService_CreateTaskList_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *taskManagementServiceClient) GetAllTask(ctx context.Context, in *NoParam, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Task], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &TaskManagementService_ServiceDesc.Streams[1], TaskManagementService_GetAllTask_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
